...
function App() {
  ...
  const handleGoogleAuth = () => {
    ...
    // Simulate OAuth error for testing (remove this in production)
    // This will be replaced with actual OAuth logic
    setTimeout(() => {
      try {
        // For testing/demo purposes - this simulates successful OAuth
        // In production, this would be replaced with actual OAuth integration
        ...
        console.log('Google OAuth successful, user profile created:', googleUser);
      } catch (error) {
        setOauthError("Erreur lors de la connexion Google");
  ...
  const handleMicrosoftAuth = () => {
    setOauthError(null);
    // Simulate Microsoft OAuth redirect
    // In a real implementation, this would redirect to Microsoft OAuth endpoint
    try {
      // Mock Microsoft OAuth flow
      console.log('Redirecting to Microsoft OAuth...');
      
      // Simulate OAuth success with mock Microsoft user data
      setTimeout(() => {
        const microsoftUser = {
          id: Date.now(),
        ...
        setIsAuthenticated(true);
        console.log('Microsoft OAuth successful, user profile created:', microsoftUser);
      }, 1000);
      
    } catch (error) {
      setOauthError("Erreur lors de la connexion Microsoft");
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <button 
              ...
              className="w-full bg-white border-2 border-gray-300 text-gray-700 py-4 px-6 rounded-2xl font-semibold text-lg hover:bg-gray-50 transition-all duration-200 transform hover:scale-105 flex items-center justify-center space-x-3"
            >
          ...
          {/* Error Display */}
          {oauthError && (
            <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-xl" data-testid="error-message">
              {oauthError}
            </div>
          )}
